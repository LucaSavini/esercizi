...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("L'occorrenza di un numero 10 " + occ(numeri, 10));
    ...
    public static int [] invert(int [] arrA, int [] arrC) {
        ...
        for (int i = 0; i < arrA.length; i ++){
            arrC[i] = arrA[maxLength];  // diminuisce ed assegna
    ...
    public static void pos (int [] arrA, int y) {
       ...
       for (int i = 0; i < arrA.length; i ++) {
           if (y == arrA[i]){
               ...
               System.out.println("l'indice del numero " + y + " é " + "[" + vari + "]");
           }

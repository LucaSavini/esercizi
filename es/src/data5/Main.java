...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("La prima data è uguale a NOW? : " + check3(data1));
        System.out.println("La seconda data è uguale a NOW? : " + check3(data2));
    ...
    public static boolean check3 (OffsetDateTime data1) {

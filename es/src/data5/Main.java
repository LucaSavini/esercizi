...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("La prima data è uguale a NOW? : " + check3(data1,data2));
        System.out.println("La seconda data è uguale a NOW? : " + check4(data1,data2));
    ...
    public static boolean check3 (OffsetDateTime data1, OffsetDateTime data2) {
        return data1.isEqual(OffsetDateTime.now());
    }
    public static boolean check4 (OffsetDateTime data1, OffsetDateTime data2) {
